            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm mt-5">
                    <div class="card-header bg-primary text-white text-center py-4">
                        <h4 class="mb-0">{{ __('Ajouter un nouveau livre') }}</h4>
                    </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6 w-full">
            <div class="card shadow-sm mt-5">
                <div class="card-header bg-primary text-white text-center py-4">
                    <h4 class="mb-0">{{ __('La liste des livres enregistres') }}</h4>
                </div>
    ...
    @foreach($livres as $livre)
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="text-end">
                ...
                <div class="flex items-center  row  justify-content-center gap-2">
                    ...
                    @else
                        ...
                        <div class="py-2 px-2 border border-grey-400 rounded-lg bg-blue-600">
                            <button wire:click='moveToEditPage({{$livre->id}})'>
                                <div >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 text-white">
